...
const page: React.FC = () => {
  return (
    ...
    <div className="relative">
      <img src="https://www.centre-europeen-formation.fr/wp-content/uploads/2023/03/slider-developpeur-web.jpeg" alt="Webflow website design advertisement with a woman's picture on the right" className="w-full rounded-t"/>
