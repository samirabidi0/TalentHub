    ...
    <div className="w-full lg:w-1/2 px-4 mb-4 lg:mb-0">
        <div className="bg-white border border-gray-200 rounded-lg shadow-lg p-6">
            <div className="flex items-center mb-4">
                ...
                <div>
                    <h1 className="text-xl font-bold">Developpement</h1>
            ...
            <div className="w-full">
                <img src="https://img-0.journaldunet.com/tdYh1oRlTPH-p9SEsdmsYvUsA5w=/1500x/smart/7966c4157484431a853c891c2c923957/ccmcms-jdn/35015620.jpg" alt="Promotional banner with woman in orange sweater promoting WordPress website design and development services, ORDER NOW button" className="w-full h-auto rounded-lg shadow-lg"/>
            </div>
        </div>
        <h1>About this service:</h1>
        <p>I'm a professional  designer with years of experience. I specialize in redesigning, custom, responsive, visually stunning, high converting Shopify dropshipping stores/websites tailored to your business's specific needs and generating significant revenue.</p>
    </div>
